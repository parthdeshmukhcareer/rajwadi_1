          ...
          {!isLoggedIn ? (
            ...
            <div style={{ padding: '40px 30px' }}>
              <div style={{ textAlign: 'center', marginBottom: '30px' }}>
                ...
                <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '24px', color: '#432227', margin: '0 0 5px 0' }}>Namaste, Guest!</h3>
                <p style={{ color: '#888', margin: 0, fontSize: '14px' }}>email@example.com</p>
              </div>
