  ...
  return (
    <section id="home-view" className="view-section active">
      ...
      <div className="static-hero-image" style={{width: '100%', position: 'relative', height: '100vh', overflow: 'hidden', background: '#000'}}>
        <img src="assets/images/rajwadi 1.png" alt="Rajwadi Hero" style={{width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top center', display: 'block', position: 'absolute', inset: '0', zIndex: '0'}} />
        ...
        <div className="custom-hero-content-wrapper">
          <div className="custom-hero-content">
            <p className="custom-hero-kicker" style={{color: '#dfceab', fontWeight: '500', letterSpacing: '0.35em', fontSize: '0.8rem', marginBottom: '25px', display: 'flex', alignItems: 'center'}}>
              THE RAJWADI LEGACY
            </p>
            <h2 className="custom-hero-title" style={{fontSize: 'clamp(2.8rem, 4.5vw, 4.6rem)', lineHeight: '1.2', letterSpacing: '0.05em', marginBottom: '25px', color: '#efe5d5'}}>
              ROYALTY WOVEN<br />IN TRADITION.
            </h2>
            <p className="custom-hero-subtitle" style={{fontSize: '1.1rem', lineHeight: '1.7', maxWidth: '500px', color: '#efe5d5', opacity: '0.9', marginBottom: '65px'}}>
            ...
            <div className="custom-hero-actions">
              <button className="custom-hero-btn-outline" onClick={() => {showView('catalog')}} style={{padding: '16px 50px', borderColor: 'rgba(223, 206, 171, 0.8)', color: '#dfceab', fontSize: '0.9rem', letterSpacing: '0.2em'}}>DISCOVER COLLECTION</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="section-padding premium-categories-section" style={{backgroundColor: '#fcf8f0', padding: '65px 4% 40px 4%', position: 'relative'}}>
        ...
        <div className="premium-stores-carousel-container" style={{position: 'relative', maxWidth: '1400px', margin: '0 auto', padding: '0 60px', marginBottom: '40px'}}>
          ...
          <div className="premium-stores-carousel" id="premiumCategoriesScroll" style={{display: 'flex', justifyContent: 'center', gap: '20px', overflowX: 'auto', scrollbarWidth: 'none', padding: '15px 5px', scrollBehavior: 'smooth'}}>
            ...
            {/*  Card 4: Jewellery  */}
            <div className="premium-store-card" style={{flex: '0 0 calc(33.333% - 15px)', minWidth: '280px', height: '380px', borderRadius: '8px', overflow: 'hidden', position: 'relative', boxShadow: '0 8px 25px rgba(0,0,0,0.1)', cursor: 'pointer'}} onClick={() => {filterByCategory('Jewellery')}}>
        ...
        <div className="elegant-moments-section" style={{display: 'flex', gap: '0', maxWidth: '1400px', margin: '0 auto', backgroundColor: 'transparent', paddingTop: '80px', paddingBottom: '60px'}}>
          ...
          <div className="elegant-left" style={{flex: '1', display: 'flex', flexDirection: 'column', padding: '40px 60px 0 0'}}>
            ...
            <a href="#" className="elegant-explore-link" onClick={() => {showView('catalog'); return false;}} style={{fontFamily: 'var(--font-sans)', fontSize: '0.8rem', letterSpacing: '0.15em', color: '#a48c5a', textTransform: 'uppercase', fontWeight: '600', display: 'inline-flex', alignItems: 'center', justifyContent: 'flex-start', gap: '10px', marginBottom: '40px', textDecoration: 'none'}}>
          ...
          <div className="elegant-right" style={{flex: '1', display: 'flex', flexDirection: 'column', borderTop: '1px solid rgba(164, 140, 90, 0.2)', borderLeft: '1px solid rgba(164, 140, 90, 0.2)'}}>
            ...
            {/*  Item 1  */}
            <div className="elegant-list-item" style={{display: 'flex', flex: '1', minHeight: '440px', borderBottom: '1px solid rgba(164, 140, 90, 0.2)', position: 'relative', overflow: 'hidden', cursor: 'pointer'}} onClick={() => {filterByOccasion('Bridal')}}>
            ...
            {/*  Item 2  */}
            <div className="elegant-list-item" style={{display: 'flex', flex: '1', minHeight: '440px', position: 'relative', overflow: 'hidden', cursor: 'pointer'}} onClick={() => {filterByOccasion('Outsider')}}>
               <div className="elegant-item-content" style={{flex: '1', padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', zIndex: '2'}}>
      ...
      <div className="dream-outfit-banner" style={{position: 'relative', width: '100%', marginTop: '0', marginBottom: '0', minHeight: '550px', overflow: 'hidden', display: 'flex', alignItems: 'center', backgroundColor: '#fcf8f0', backgroundImage: 'linear-gradient(to right, #fcf8f0 30%, rgba(252, 248, 240, 0.85) 45%, transparent 55%), url("assets/images/fe4dee22-0969-43ab-8a9f-ecb2dc745a48.png")', backgroundSize: '90%', backgroundPosition: 'right center', backgroundRepeat: 'no-repeat'}}>
        ...
        <div className="dream-outfit-content" style={{flex: '0 0 55%', padding: '60px 80px 60px 100px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', textAlign: 'left'}}>  
          ...
          <p style={{fontFamily: 'var(--font-sans)', color: '#333', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '40px', maxWidth: '450px'}}>
            A fully custom made outfit crafted specially for you!<br />
            Come and explore the exotic ethnic collection with Rajwadi.
          </p>
          
          <button style={{backgroundColor: '#432227', color: '#fff', border: '1px solid #432227', padding: '15px 40px', fontFamily: 'var(--font-sans)', fontSize: '0.85rem', letterSpacing: '0.15em', fontWeight: '600', textTransform: 'uppercase', display: 'inline-flex', alignItems: 'center', gap: '10px', cursor: 'pointer', transition: 'background-color 0.3s ease', boxShadow: '0 0 0 4px rgba(67, 34, 39, 0.1)'}} onClick={() => {filterByCategory('Rajputi Poshakh')}} onMouseOver={() => {this.style.backgroundColor='#2a1518'}} onMouseOut={() => {this.style.backgroundColor='#432227'}}>
